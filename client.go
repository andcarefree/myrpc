...
//ErrShutdown means serveic close
var ErrShutdown = errors.New("connection is shut down")

//Close means Tcp conn in codec in client close
...
//NewClient return a client with speasial option and coon
